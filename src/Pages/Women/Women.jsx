...
const Women = () => {
  ...
  let fliteredItems = products.filter(item => (item.category == "women"))
  ...
  return (
    <div>
      <Navbar />
      <h1 style={{ fontFamily: "Cursive", fontSize: "40px", color: "white",padding:"20px 0", background: "#242424", textAlign: "center" }}>Womens-Section</h1>
